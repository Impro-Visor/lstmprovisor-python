...
class QueueManager( object ):
    ...
    def process(self, input_activations, extra_info=False):
        ...
        sparsity_loss = self.get_loss(raw_feature_strengths, raw_feature_vects, extra_info=extra_info)

        if extra_info:
            sparsity_loss, info = sparsity_loss
            return sparsity_loss, raw_feature_strengths, raw_feature_vects, info
        else:
